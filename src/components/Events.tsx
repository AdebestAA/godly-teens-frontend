...
const ymsData = [
  {
    ...
    details: [
      ...
      { label: "Speakers", value: "Bro Segun Ariyo, Bro Sunday Akande, Mr Adeleke Adebayo" },
  ...
  },
  {
    ...
    details: [
      ...
      { label: "Speakers", value: "Bro Kunmi Adedeji, Dr Mrs Sansi, Mr Adebayo Adeleke" },
  ...
  },
  {
    ...
    details: [
      ...
      { label: "Speakers", value: "Revd. Albert Oduwole, Mr Niyi Odetola, Mr Akinyemi Lapinni" },
      { label: "Venue", value: "Federal college of agriculture, Moore plantation" },
    ],
  },
  {
    year: "2022",
        ...
        <ScrollReveal direction="up">
          <div className="text-center mb-16">
            ...
            <h2 className="font-montserrat font-extrabold text-[clamp(32px,4vw,52px)] leading-[1.05] tracking-tight max-w-4xl mx-auto mb-8">
              ...
              <em className="font-fraunces italic font-medium text-gold-dark">YMS</em>
            </h2>
            <p className="text-xl text-ink-60 max-w-3xl mx-auto leading-relaxed">
              The Youth Ministers' Summit (YMS) is a flagship annual gathering of Godly Teens International Ministry, bringing together teenagers and young people for powerful encounters through worship, teachings, mentorship, and life-transforming experiences.
            </p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal direction="up">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="h-70 bg-linear-to-br from-green-600 to-green-800 rounded-2xl relative flex items-start justify-start p-6">
              <span className="inline-flex px-3 py-1.5 text-[11px] font-bold text-white bg-green-900 rounded-full">Annual Summit</span>
            </div>
            <div className="flex flex-col justify-center">
              <h3 className="font-fraunces font-bold text-[clamp(24px,2.5vw,36px)] mb-4 text-ink leading-tight">
                Youth Ministers' Summit <em className="font-montserrat italic">2026</em>
              </h3>
              <p className="text-[14px] text-ink-60 mb-8 leading-relaxed max-w-112.5">
                Each year is marked by a unique theme that reflects God's direction and focus for the season. YMS continues to serve as a platform for spiritual awakening, direction, and empowerment.
              </p>
            </div>
          </div>
        </ScrollReveal>
              ...
              {ymsData.map((yms) => (
                ...
                >
                  ...
                  {yms.photos.length > 0 ? (
                    ...
                    <div className={`relative h-48 bg-linear-to-br ${yms.gradient} flex items-center justify-center`}>
                      <div className="text-center">
                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className={`${yms.iconColor} mx-auto mb-2`}>
                          <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
                          <circle cx="9" cy="9" r="2"></circle>
                          <path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"></path>
                        </svg>
                        <p className={`text-xs ${yms.labelColor} font-medium`}>YMS {yms.year}</p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="p-6">
                    <div className="flex justify-between items-start mb-3">
                      <h5 className="font-bold text-green-800 text-lg">{yms.year}</h5>
                      <span className="text-xs text-ink-60 bg-green-50 px-2 py-1 rounded-full">{yms.date}</span>
                    </div>
                    <p className="font-semibold text-ink-80 mb-3 text-sm">Theme: "{yms.theme}"</p>
        ...
        <ScrollReveal direction="up">
          <div className="p-6 bg-linear-to-r from-green-50 to-green-100 border border-green-200 rounded-2xl">
            <p className="text-ink-80 font-semibold text-center">
              YMS continues to serve as a platform for spiritual awakening, direction, and empowerment, raising a generation of teenagers and youths who are guided by God and committed to purposeful living.
            </p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal direction="up">
          <div className="mt-16">
            <div className="text-center mb-12">
              <h3 className="font-fraunces text-3xl font-semibold text-green-800 mb-4">What to Expect at YMS</h3>
              <p className="text-ink-60 max-w-2xl mx-auto">
                Each YMS gathering brings together teenagers and young people for powerful encounters through worship, teachings, mentorship, and life-transforming experiences.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="group relative p-6 bg-white border-2 border-green-100 rounded-2xl shadow-md hover:shadow-2xl hover:border-gold transition-all duration-500 overflow-hidden">
                ...
                <h4 className="font-montserrat font-bold text-green-800 text-lg mb-3">Worship & Praise</h4>
                <p className="text-ink-60 text-sm leading-relaxed">Powerful worship sessions that create an atmosphere for encountering God and experiencing His presence.</p>
              </div>
              ...
              <div className="group relative p-6 bg-white border-2 border-green-100 rounded-2xl shadow-md hover:shadow-2xl hover:border-gold transition-all duration-500 overflow-hidden">
                ...
                <h4 className="font-montserrat font-bold text-green-800 text-lg mb-3">Biblical Teachings</h4>
                <p className="text-ink-60 text-sm leading-relaxed">Deep, relevant teachings from God's Word that address contemporary issues and provide spiritual guidance.</p>
              </div>
              ...
              <div className="group relative p-6 bg-white border-2 border-green-100 rounded-2xl shadow-md hover:shadow-2xl hover:border-gold transition-all duration-500 overflow-hidden">
                ...
                <h4 className="font-montserrat font-bold text-green-800 text-lg mb-3">Mentorship & Fellowship</h4>
                <p className="text-ink-60 text-sm leading-relaxed">Opportunities for mentorship, networking, and building lasting relationships with fellow believers.</p>
              </div>
            </div>
          </div>
        </ScrollReveal>
