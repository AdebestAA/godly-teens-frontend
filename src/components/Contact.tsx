        ...
        <ScrollReveal direction="left">
          <div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="text-[13px] text-ink-60 leading-relaxed">
                    Plot 4, Adeoyo State Hospital Road,
                    <br />
            ...
            <div className="flex gap-3">
              <a
                href="#"
                className="flex items-center justify-center w-10 h-10 rounded-full border border-line hover:border-green-800 hover:bg-green-50 transition-all text-ink-60 hover:text-green-800"
          ...
          >
            ...
            <div className="mb-4">
              ...
              >
                ...
                <option value="Partnering financially">
                  Partnering financially
                </option>
                <option value="Volunteering">Volunteering</option>
                <option value="Event registration">Event registration</option>
                <option value="Media / press enquiry">
                  Media / press enquiry
                </option>
              </select>
