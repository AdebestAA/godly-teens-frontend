...
const ScriptureRibbon: React.FC = () => {
  ...
  return (
    <ScrollReveal direction="none" distance={0}>
      <div className="bg-white border-2 border-green-100 text-green-900 py-[14px] overflow-hidden border-t border-gold/20 border-b border-gold/20">
        <div className="flex animate-slide font-fraunces text-[16px] italic font-normal">
          <span className="inline-flex items-center gap-[60px] pr-[60px] shrink-0">{verse}</span>
          <span className="inline-flex items-center gap-[60px] pr-[60px] shrink-0">{verse}</span>
          <span className="inline-flex items-center gap-[60px] pr-[60px] shrink-0">{verse}</span>
          <span className="inline-flex items-center gap-[60px] pr-[60px] shrink-0">{verse}</span>
        </div>
