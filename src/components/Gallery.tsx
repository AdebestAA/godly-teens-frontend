        ...
        <div className="mt-16 bg-paper border border-line rounded-[20px] p-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              ...
              <div className="text-[14px] text-ink-60">Photos Captured</div>
            </div>
            <div>
              <div className="font-fraunces text-[32px] font-semibold text-green-800 mb-2">
                50+
              </div>
              <div className="text-[14px] text-ink-60">Events Documented</div>
            </div>
            <div>
              <div className="font-fraunces text-[32px] font-semibold text-green-800 mb-2">
                12K+
              </div>
              <div className="text-[14px] text-ink-60">Lives Impacted</div>
            </div>
            <div>
              <div className="font-fraunces text-[32px] font-semibold text-green-800 mb-2">
                28
              </div>
              <div className="text-[14px] text-ink-60">Countries Reached</div>
            </div>
          </div>
        </div>
