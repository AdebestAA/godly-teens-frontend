      ...
      <div className="max-w-[1280px] mx-auto px-7">
        ...
        >
          <article className="bg-white/90 backdrop-blur-sm border-0 rounded-2xl p-7 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div className="text-[64px] font-fraunces text-gold-soft mb-3 leading-none">"</div>
            ...
            <div className="flex items-center gap-3 pt-6 border-t border-gray-200">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-green-600 to-green-800 text-white font-bold text-[12px]">DA</div>
              <div>
                <strong className="block text-[13px] font-semibold text-ink">Daniel Adeyemi</strong>
                <span className="text-[12px] text-ink-60">18 · Abuja, Nigeria</span>
              </div>
            </div>
          </article>
          ...
          <article className="bg-white/90 backdrop-blur-sm border-0 rounded-2xl p-7 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="flex items-center gap-3 pt-6 border-t border-gray-200">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-gold to-gold-dark text-ink font-bold text-[12px]">EO</div>
              <div>
                <strong className="block text-[13px] font-semibold text-ink">Esther Okon</strong>
          ...
          <article className="bg-white/90 backdrop-blur-sm border-0 rounded-2xl p-7 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="flex items-center gap-3 pt-6 border-t border-gray-200">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-purple-600 to-purple-800 text-white font-bold text-[12px]">MO</div>
              <div>
                <strong className="block text-[13px] font-semibold text-ink">Mr. &amp; Mrs. Olatunji</strong>
                <span className="text-[12px] text-ink-60">Parents · Ibadan, Nigeria</span>
              </div>
            </div>
          </article>
        </ScrollReveal>
