          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="inline-flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <small className="text-[11px] text-gold-soft">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/about"
                  className="text-[13px] text-green-100 hover:text-gold transition-colors"
                >
                  About us
                </Link>
              </li>
            ...
            <ul className="space-y-2">
              <li>
                <button
                  ...
                  className="text-[13px] text-green-100 hover:text-gold transition-colors cursor-pointer"
                >
                  Become a member
                </button>
              </li>
