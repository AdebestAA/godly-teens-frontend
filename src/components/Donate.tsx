      ...
      <div className="max-w-[1280px] mx-auto px-7 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <ScrollReveal direction="left">
          <div>
            ...
            <p className="text-[13px] text-ink-40 flex items-center gap-1">
              <Lock className="w-3.5 h-3.5 inline" /> Secure payments via Stripe, PayPal and Flutterwave.
        ...
        <ScrollReveal direction="right">
          <aside className="bg-paper border border-line rounded-[20px] p-9 bg-white border-2 border-green-100">
            ...
            <div className="flex gap-2.5 mt-4 pt-5 border-t border-dashed border-line items-center">
              <span className="text-[11px] text-ink-40 tracking-[0.08em] uppercase">We accept</span>
              <div className="p-1.5 px-2.5 bg-white border border-line rounded-md text-[11px] font-bold text-ink-60">VISA</div>
              <div className="p-1.5 px-2.5 bg-white border border-line rounded-md text-[11px] font-bold text-ink-60">Master</div>
              <div className="p-1.5 px-2.5 bg-white border border-line rounded-md text-[11px] font-bold text-ink-60">PayPal</div>
              <div className="p-1.5 px-2.5 bg-white border border-line rounded-md text-[11px] font-bold text-ink-60">Flw</div>
            </div>
          </aside>
        </ScrollReveal>
      </div>
